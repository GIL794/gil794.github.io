...
<div class="container">
  ...
  <div class="card-grid">
    <div class="feature-card">
      <h3>🚀 My Journey</h3>
      <p>My path has taken me through the evolving landscape of digital innovation, from mastering advanced automation systems to leading cross-functional teams that transform bold ideas into tangible results.</p>
    ...
    <div class="feature-card">
      <h3>🎯 What I Do</h3>
      <p>I specialise in automation strategy, digital transformation, and innovation leadership. My approach combines deep technical expertise with strategic business acumen to deliver results that exceed expectations.</p>
      <p>Whether it's streamlining complex processes, implementing cutting-edge technologies, or building high-performing teams, I focus on creating sustainable value and driving meaningful change.</p>
    </div>
    <div class="feature-card">
      <h3>💡 My Philosophy</h3>
      <p>I believe that the best innovations arise from understanding both the technical possibilities and the human needs they serve. Technology should amplify human potential, not replace it.</p>
      <p>This philosophy guides everything I do—from the solutions I design to the teams I lead and the partnerships I build.</p>
    </div>
  </div>
  <div class="section">
    <h2>Let's Connect</h2>
    ...
    <div style="text-align: centre; margin-top: 2rem;">
      ...
      <a class="cta-btn secondary" href="/projects/" style="margin-left: 1rem;">View My Work</a>
    </div>
  </div>
</div>
